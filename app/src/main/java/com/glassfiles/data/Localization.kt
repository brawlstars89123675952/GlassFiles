...
val continueLabel get() = s("Продолжить", "Continue")
val savedLabel get() = s("Сохранено", "Saved")
val speakPrompt get() = s("Говорите...", "Speak...")
val voiceNotAvailable get() = s("Голосовой ввод недоступен", "Voice not available")
val cameraNotAvailable get() = s("Камера недоступна", "Camera not available")
val editMessage get() = s("Редактировать сообщение", "Edit message")
val aiContextLabel get() = s("Контекст", "Context")
val aiDefaultModelHint get() = s("Модели по умолчанию можно выбрать позже в AI настройках чата", "Default models can be selected later in the AI chat settings")
val aiAddApiKeyHint get() = s("Добавьте API ключ в настройках", "Add API key in settings")
val analyzeFilePrompt get() = s("Проанализируй этот файл", "Analyze this file")
val askAboutImagePrompt get() = s("Что на этом изображении?", "What is in this image?")
val generateImageFromPhotoPrompt get() = s("Сгенерируй картинку по этому фото", "Generate image inspired by this photo")
val currentFolderPrompt get() = s("Текущая папка", "Current folder")
val savedFileToast get() = s("Сохранено:", "Saved:")
val codeBlockLabel get() = s("код", "code")
val visionBadge get() = s("Vision", "Vision")
val filesBadge get() = s("Файлы", "Files")
val codeBadge get() = s("Код", "Code")

val aiProvidersTitle get() = s("AI провайдеры", "AI Providers")
val aiProvidersSubtitle get() = s("Добавьте один или несколько API ключей для AI чата, кодинга, картинок и видео", "Add one or more API keys to enable AI chat, coding, image, and video workflows")
val searchChats get() = s("Поиск чатов...", "Search chats...")
val aiChatTitle get() = s("AI", "AI")
val aiCodingTitle get() = s("AI Кодинг", "AI Coding")
val aiCodingSubtitle get() = s("Кодинг и агентные модели", "Coding and agent-oriented models")
val aiWorkspace get() = s("Кодинг workspace", "Coding Workspace")
val aiWorkspaceSubtitle get() = s("Используйте coding-модели для рефакторинга, фиксов, shell-команд и агентных задач", "Use coding-capable models for refactors, fixes, shell commands, and agent-like task prompting.")
val chatMode get() = s("Чат", "Chat")
val imageMode get() = s("Картинка", "Image")
val videoMode get() = s("Видео", "Video")
val providerApiKey get() = s("API ключ", "API key")
val providerBaseUrl get() = s("Base URL / Proxy", "Base URL / Proxy")
val providerBaseUrlOptional get() = s("Base URL / Proxy (опционально)", "Base URL / Proxy (optional)")
val providerRegion get() = s("Регион", "Region")
val selectModel get() = s("Выбрать модель", "Select Model")
val aiSettingsTitle get() = s("Настройки AI", "AI Settings")
val chatModelTitle get() = s("Модель чата", "Chat model")
val codingModelTitle get() = s("Модель кодинга", "Coding model")
val imageModelTitle get() = s("Модель картинок", "Image model")
val videoModelTitle get() = s("Модель видео", "Video model")
val generatedImageFallback get() = s("Картинка сгенерирована, preview недоступен", "Image generated, preview unavailable")
val generatedImageMessage get() = s("Картинка сгенерирована по запросу:", "Image generated from prompt:")
val generatedVideoMessage get() = s("Подготовлен запрос на генерацию видео:", "Video generation request prepared for:")
val fileAttachedLabel get() = s("Файл прикреплён", "File attached")
val thinking get() = s("Думаю...", "Thinking...")
val preparing get() = s("Подготовка...", "Preparing...")
val describeImagePrompt get() = s("Опишите картинку для генерации...", "Describe image to generate...")
val describeVideoPrompt get() = s("Опишите видео для генерации...", "Describe video to generate...")
val describeCodingTask get() = s("Опишите coding-задачу...", "Describe coding task...")
val agentStylePrompt get() = s("Промпт в агентном стиле", "Agent-style coding prompt")
val explainCodeAction get() = s("Объяснить код", "Explain code")
val fixBugAction get() = s("Исправить баг", "Fix bug")
val generatePatchAction get() = s("Сгенерировать патч", "Generate patch")
val writeScriptAction get() = s("Написать скрипт", "Write script")
val refactorFileAction get() = s("Рефактор файла", "Refactor file")
val createWorkflowAction get() = s("Создать workflow", "Create workflow")
