...
- Обязательное правило для всех следующих GitHub изменений: каждый новый экран, подэкран, диалог, overlay и tab-detail должен корректно обрабатывать системный back gesture и стрелку назад. Back обязан закрывать ближайшее локальное состояние и сохранять место пользователя, а не сбрасывать GitHub модуль на главный экран.
- Покрыты:
